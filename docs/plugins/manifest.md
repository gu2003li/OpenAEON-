...
read_when:
  - You are building a OpenAEON plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (openaeon.plugin.json)

Every plugin **must** ship a `openaeon.plugin.json` file in the **plugin root**.
OpenAEON uses this manifest to validate configuration **without executing plugin
