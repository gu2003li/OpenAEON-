...
OpenAEON ships three update channels:
...
When you **explicitly** switch channels with `--channel`, OpenAEON also aligns
the install method:
...
When you switch channels with `openaeon update`, OpenAEON also syncs plugin sources:
