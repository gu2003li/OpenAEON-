...
read_when:
  ...
  - Wiring external systems into OpenAEON
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your OpenAEON config directory (typically `~/.openaeon/hooks/transforms`).
...
- `openaeon webhooks gmail setup` writes `hooks.gmail` config for `openaeon webhooks gmail run`.
