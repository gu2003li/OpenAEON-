...
read_when:
  ...
  - Reviewing OpenAEON security posture
title: "Pairing"
---

# Pairing

“Pairing” is OpenAEON’s explicit **owner approval** step.
...
Stored under `~/.openaeon/credentials/`:
...
3. On your phone, open the OpenAEON iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `openaeon nodes pending/approve`) is a
