...
read_when:
  - You want OpenAEON to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables OpenAEON to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`openaeon onboard`) and `openaeon channels add` list optional channel plugins.
...
```bash
openaeon plugins install @openaeon/nostr
```

Use a local checkout (dev workflows):

```bash
openaeon plugins install --link <path-to-openaeon>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "openaeon",
        "displayName": "OpenAEON",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "openaeon@example.com",
        "lud16": "openaeon@example.com"
      }
    }
  }
}
