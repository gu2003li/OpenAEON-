...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure OpenAEON HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `openaeon pairing approve slack <code>`.
...
OpenAEON supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, OpenAEON falls back to normal delivery for remaining payloads.
