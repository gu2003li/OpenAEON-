...
- Install via CLI: `openaeon plugins install @openaeon/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `openaeon plugins install ./extensions/zalo`
   - From npm (if published): `openaeon plugins install @openaeon/zalo`
...
- Approve via:
  - `openaeon pairing list zalo`
  - `openaeon pairing approve zalo <CODE>`
...
- Example: `openaeon message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `openaeon channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `openaeon logs --follow`
