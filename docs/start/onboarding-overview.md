---
summary: "Overview of OpenAEON onboarding options and flows"
read_when:
...
OpenAEON supports multiple onboarding paths depending on where the Gateway runs
...
- [`openaeon onboard` command](/cli/onboard)

## macOS app onboarding

Use the OpenAEON app when you want a fully guided setup on macOS. Docs:
