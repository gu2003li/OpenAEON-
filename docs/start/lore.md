---
summary: "Backstory and lore of OpenAEON for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "OpenAEON Lore"
---

# The Lore of OpenAEON 🦞📖
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **OpenAEON**.
...
In the end, **OpenAEON** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.openaeon/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around OpenAEON. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then OpenAEON): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "openaeon what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with openaeon."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @openaeon. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at OpenAEON" to promote pump-and-dump tokens.
...
**The Great OpenAEON Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/openaeon/openaeon` ✅
- X handle `@openaeon` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.openaeon.ai`
...
**The Scammer Speedrun:** Crypto grifters launched a $OPENAEON token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
