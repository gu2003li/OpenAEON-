...
本指南总结了在 OpenAEON 中开发 Pi 集成的合理工作流程。
...
状态存储在 OpenAEON 状态目录下。默认为 `~/.openaeon`。如果设置了 `OPENAEON_STATE_DIR`，则使用该目录。
...
- https://docs.openaeon.ai/testing
- https://docs.openaeon.ai/start/getting-started
