---
summary: "VPS hosting hub for OpenAEON (Oracle/Fly/Hetzner/GCP/exe.dev)"
read_when:
...
- `OPENAEON_NO_RESPAWN=1` avoids extra startup overhead from a self-respawn path.
...
- Add service env for stable startup path:
  - `OPENAEON_NO_RESPAWN=1`
  - `NODE_COMPILE_CACHE=/var/tmp/openaeon-compile-cache`
