---
summary: "Use Qianfan's unified API to access many models in OpenAEON"
read_when:
...
3. OpenAEON installed on your system
...
4. Copy the API key for use with OpenAEON

## CLI setup

```bash
openaeon onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [OpenAEON Configuration](/gateway/configuration)
