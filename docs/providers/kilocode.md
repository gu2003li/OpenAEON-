---
summary: "Use Kilo Gateway's unified API to access many models in OpenAEON"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in OpenAEON
---
...
```bash
openaeon onboard --kilocode-api-key <key>
```
