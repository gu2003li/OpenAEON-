...
You can point OpenAEON at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OpenAEON
...
- [Anthropic provider](/providers/anthropic) - Native OpenAEON integration with Claude setup-token or API keys
