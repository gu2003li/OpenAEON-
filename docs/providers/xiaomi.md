---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OpenAEON"
read_when:
  - You want Xiaomi MiMo models in OpenAEON
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OpenAEON uses
