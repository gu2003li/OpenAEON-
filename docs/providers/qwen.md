---
summary: "Use Qwen OAuth (free tier) in OpenAEON"
read_when:
  - You want to use Qwen with OpenAEON
...
If you already logged in with the Qwen Code CLI, OpenAEON will sync credentials
