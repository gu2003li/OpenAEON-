---
summary: "Use NVIDIA's OpenAI-compatible API in OpenAEON"
read_when:
  - You want to use NVIDIA models in OpenAEON
...
openaeon onboard --auth-choice skip
openaeon models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
