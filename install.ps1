...
# Usage: iwr -useb https://raw.githubusercontent.com/luolin-ai.openaeonWeComzh/main/install.ps1 | iex
#        & ([scriptblock]::Create((iwr -useb https://raw.githubusercontent.com/luolin-ai.openaeonWeComzh/main/install.ps1))) -Tag beta -NoOnboard -DryRun
    ...
    try {
        ...
        if ($LASTEXITCODE -ne 0) {
            ...
            if ($npmOutput -match "spawn git" -or $npmOutput -match "ENOENT.*git") {
                ...
                Write-Host "  iwr -useb https://raw.githubusercontent.com/luolin-ai.openaeonWeComzh/main/install.ps1 | iex" -ForegroundColor Cyan
            }
...
function Install-OpenAEONFromGit {
    ...
    $repoUrl = "https://github.com/luolin-ai.openaeonWeComzh.git"
