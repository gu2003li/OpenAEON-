...
export const zh_TW: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "安全地編輯 ~/.openaeon/openaeon.json。",
  ...
  overview: {
    ...
    pairing: {
      hint: "此裝置需要閘道主機的配對批准。",
      mobileHint:
        "在手機上？從桌面執行 openaeon dashboard --no-open 複製完整 URL（包括 #token=...）。",
    },
    insecure: {
  ...
  chat: {
    ...
    emptyTitle: "永恆協議 | THE AEON PROTOCOL",
    emptySubtitle: "哲學思辨與多維網絡自我進化矩陣。",
    emptyAction1: "啟動遞歸生成...",
    emptyAction2: "處理多維輸入向量...",
    emptyAction3: "解析悖論拓撲圖...",
    sidebarRoster: "進化節點 (Evolution Nodes)",
    sidebarPlan: "自我進化矩陣 (Self-Evolution Matrix)",
    sidebarWorking: "演算中 | Computing",
    sidebarIdle: "靜默 | Dormant",
    sidebarResultTitle: "↳ 進化演算輸出",
  },
  languages: {
    en: "English",
    zhCN: "简体中文 (簡體中文)",
