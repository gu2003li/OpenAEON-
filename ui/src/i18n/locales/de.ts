...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.openaeon/openaeon.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von openaeon dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
  ...
  chat: {
    ...
    emptyAction1: "Initiate recursive generation...",
    emptyAction2: "Process multidimensional input...",
    emptyAction3: "Analyze paradox patterns...",
