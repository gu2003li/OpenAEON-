...
export const miscStyles = html`
  <style>
    ...
    @keyframes sandbox-scale-up { from { transform: scale(0.9) translateY(20px); opacity: 0; } to { transform: scale(1) translateY(0); opacity: 1; } }
    ...
    .sandbox-recruit-title { font-size: 1.5rem; font-weight: 700; color: #f8fafc; }
    .sandbox-recruit-close { cursor: pointer; color: #94a3b8; font-size: 1.5rem; border: none; background: none; }

    .sandbox-recruit-tabs { display: flex; gap: 24px; padding: 0 24px; border-bottom: 1px solid rgba(255,255,255,0.05); }
    .sandbox-recruit-tab {
      padding: 16px 0; border-bottom: 2px solid transparent; color: #94a3b8; font-weight: 600; cursor: pointer;
    }
    .sandbox-recruit-tab--active { color: #8b5cf6; border-color: #8b5cf6; }
    ...
    .recruit-card:hover { background: rgba(255,255,255,0.06); border-color: #8b5cf660; transform: translateY(-4px); }
    .recruit-card__preview { height: 120px; display: flex; align-items: center; justify-content: center; margin-bottom: 10px; pointer-events: none; }
    .recruit-card__name { font-weight: 700; color: #f8fafc; font-size: 1.1rem; }
    .recruit-card__role { font-size: 0.8rem; color: #94a3b8; }
    .recruit-card__btn { margin-top: auto; width: 100%; }
    ...
    .singularity-core {
      ...
      border-radius: 50%;
      box-shadow: 0 0 50px #22d3ee, 0 0 100px rgba(34, 211, 238, 0.4);
      animation: singularity-pulse 4s ease-in-out infinite;
    }

    @keyframes singularity-pulse {
      0%, 100% { transform: scale(1); opacity: 0.8; box-shadow: 0 0 50px #22d3ee; }
      50% { transform: scale(1.2); opacity: 1; box-shadow: 0 0 80px #22d3ee, 0 0 150px rgba(34, 211, 238, 0.6); }
    }
    ...
    .ring--1 { width: 100px; height: 100px; animation: singularity-spin 10s linear infinite; }
    .ring--2 { width: 160px; height: 160px; animation: singularity-spin 15s linear reverse infinite; border-style: dashed !important; }
    ...
    @keyframes self-repair-glitch {
      ...
      5% { clip: rect(2px, 450px, 12px, 0); transform: skew(0.8deg); }
      10% { clip: rect(0, 0, 0, 0); }
      15% { clip: rect(67px, 450px, 92px, 0); transform: skew(0.2deg); }
