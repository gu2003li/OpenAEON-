...
# Output:
# - dist/OpenAEON.app
# - dist/OpenAEON-<version>.zip
# - dist/OpenAEON-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.openaeon.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/OpenAEON.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/OpenAEON-$VERSION.zip"
DMG="$ROOT_DIR/dist/OpenAEON-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OpenAEON-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/OpenAEON-$VERSION.dSYM.zip"
