...
- Keep product names in English: OpenAEON, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the OpenAEON Gateway, use “Gateway 网关”.
