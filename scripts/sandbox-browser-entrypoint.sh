...
export DISPLAY=:1
export HOME=/tmp/openaeon-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${OPENAEON_BROWSER_CDP_PORT:-${AEONPROPHET_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${OPENAEON_BROWSER_CDP_SOURCE_RANGE:-${AEONPROPHET_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${OPENAEON_BROWSER_VNC_PORT:-${AEONPROPHET_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${OPENAEON_BROWSER_NOVNC_PORT:-${AEONPROPHET_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${OPENAEON_BROWSER_ENABLE_NOVNC:-${AEONPROPHET_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${OPENAEON_BROWSER_HEADLESS:-${AEONPROPHET_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${OPENAEON_BROWSER_NO_SANDBOX:-${AEONPROPHET_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${OPENAEON_BROWSER_NOVNC_PASSWORD:-${AEONPROPHET_BROWSER_NOVNC_PASSWORD:-}}"
