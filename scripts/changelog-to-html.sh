...
if [[ -z "$version_content" ]]; then
  echo "<h2>OpenAEON $VERSION</h2>"
  echo "<p>Latest OpenAEON update.</p>"
  echo "<p><a href=\"https://github.com/openaeon/openaeon/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
