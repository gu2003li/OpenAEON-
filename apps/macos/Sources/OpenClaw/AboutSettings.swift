...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/openaeon/OpenAEON") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub 源码",
                    url: "https://github.com/openaeon/OpenAEON")
                AboutLinkRow(icon: "globe", title: "官网", url: "https://github.com/openaeon/OpenAEON")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "OpenAEONBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenAEONBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OpenAEONGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenAEONGitCommit") as? String) ??
            "unknown"
    }
