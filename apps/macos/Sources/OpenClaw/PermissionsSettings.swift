...
private struct LocationAccessSettings: View {
    @AppStorage(locationModeKey) private var locationModeRaw: String = OpenAEONLocationMode.off.rawValue
    ...
    private var locationMode: OpenAEONLocationMode {
        OpenAEONLocationMode(rawValue: self.locationModeRaw) ?? .off
    }

    private func requestLocationAuthorization(mode: OpenAEONLocationMode) async -> Bool {
