...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.openaeon", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.openaeon", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [OpenAEONChatMessage] = messages.compactMap { item in
