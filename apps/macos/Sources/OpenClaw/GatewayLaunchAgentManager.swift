...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.openaeon", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".openaeon/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.openaeonCommand(
            subcommand: "gateway",
