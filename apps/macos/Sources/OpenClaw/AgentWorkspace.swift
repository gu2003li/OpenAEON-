...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.openaeon", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return OpenAEONConfigFile.defaultWorkspaceURL() }
