...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.openaeon", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("OpenAEON/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__openaeon__/a2ui/").absoluteString + "?platform=macos"
    }
