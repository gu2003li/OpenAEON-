...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .openaeonSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OpenAEONPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OpenAEONPaths.stateDirURL.path
...
extension Notification.Name {
    static let openaeonSelectSettingsTab = Notification.Name("openaeonSelectSettingsTab")
}
