...
/// Menu contents for the OpenAEON menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("关于 OpenAEON") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "OpenAEON Not Configured"
        case .remote:
            "Remote OpenAEON Active"
        case .local:
            "OpenAEON Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .openaeonSelectSettingsTab, object: tab)
        }
    }
