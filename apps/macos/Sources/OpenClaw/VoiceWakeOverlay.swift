...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.openaeon", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other OpenAEON windows, but below the system’s pop-up menus.
