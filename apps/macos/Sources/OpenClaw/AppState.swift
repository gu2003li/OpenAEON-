...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = OpenAEONConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = OpenAEONConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = OpenAEONConfigFile.loadDict()
            ...
            OpenAEONConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/openaeon"
        state.remoteCliPath = ""
        return state
    }
}
