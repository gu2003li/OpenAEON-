...
enum UIStrings {
    static let welcomeTitle = "Welcome to OpenAEON"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "openaeon.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: OpenAEONChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g openaeon@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: OpenAEONChatViewModel(
