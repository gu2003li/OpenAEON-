...
enum OpenAEONConfigFile {
    private static let logger = Logger(subsystem: "ai.openaeon", category: "config")
    ...
    static func stateDirURL() -> URL {
        OpenAEONPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        OpenAEONPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-openaeon-config-file",
            "event": "config.write",
