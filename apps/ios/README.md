# OpenAEON iOS (Super Alpha)

NO TEST FLIGHT AVAILABLE AT THIS POINT

This iPhone app is super-alpha and internal-use only. It connects to an OpenAEON Gateway as a `role: node`.
...
- `apps/ios/Sources/OpenAEON.entitlements` sets `aps-environment` to `development`.
