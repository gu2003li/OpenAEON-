...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: OpenAEONPhotosLatestParams) async throws -> OpenAEONPhotosLatestPayload {
        ...
        var results: [OpenAEONPhotoPayload] = []
        ...
        return OpenAEONPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> OpenAEONPhotoPayload
    {
