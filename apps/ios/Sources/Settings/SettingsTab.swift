...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = OpenAEONLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = OpenAEONLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.openaeon.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected OpenAEON agent.") { newValue in
                        ...
                        self.featureToggle("允许使用相机",
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while OpenAEON is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for OpenAEON. "
                        ...
                        Picker("启用位置访问", selection: self.$locationEnabledModeRaw) {
                            Text("关闭").tag(OpenAEONLocationMode.off.rawValue)
                            Text("While Using").tag(OpenAEONLocationMode.whileUsing.rawValue)
                            Text("始终").tag(OpenAEONLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle("系统防休眠保持活跃",
                            ...
                            help: "Keeps the screen awake while OpenAEON is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("OpenAEON", value: DeviceInfoHelper.openClawVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = OpenAEONLocationMode(rawValue: newValue) else { return }
                Task {
