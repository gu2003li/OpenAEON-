...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.openaeon.gateway"
    private static let nodeService = "ai.openaeon.node"
    private static let talkService = "ai.openaeon.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.openaeon.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.openaeon.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("openaeon-gateway.log")
    }
