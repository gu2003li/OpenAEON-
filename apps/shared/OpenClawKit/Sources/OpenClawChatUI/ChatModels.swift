...
public typealias OpenAEONPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OpenAEONPlatformImage = UIImage
#endif

public struct OpenAEONChatUsageCost: Codable, Hashable, Sendable {
...
public struct OpenAEONChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OpenAEONChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OpenAEONChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OpenAEONChatMessageContent: Codable, Hashable, Sendable {
...
public struct OpenAEONChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OpenAEONChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OpenAEONChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OpenAEONChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OpenAEONChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(OpenAEONChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([OpenAEONChatMessageContent].self, forKey: .content) {
...
public struct OpenAEONChatHistoryPayload: Codable, Sendable {
...
public struct OpenAEONSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OpenAEONSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OpenAEONSessionPreviewItem]
}

public struct OpenAEONSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OpenAEONSessionPreviewEntry]

    public init(ts: Int, previews: [OpenAEONSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OpenAEONChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OpenAEONChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OpenAEONAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OpenAEONChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct OpenAEONGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OpenAEONPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OpenAEONPlatformImage?
...
public struct OpenAEONChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
