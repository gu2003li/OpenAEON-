...
public enum OpenAEONTalkCommand: String, Codable, Sendable {
...
public struct OpenAEONTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct OpenAEONTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
