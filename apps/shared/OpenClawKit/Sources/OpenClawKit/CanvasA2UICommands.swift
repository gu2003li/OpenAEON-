...
public enum OpenAEONCanvasA2UICommand: String, Codable, Sendable {
...
public struct OpenAEONCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct OpenAEONCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
