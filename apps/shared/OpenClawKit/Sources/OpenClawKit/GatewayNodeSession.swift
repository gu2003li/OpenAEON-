...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.openaeon", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.openaeon", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: OpenAEONProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
