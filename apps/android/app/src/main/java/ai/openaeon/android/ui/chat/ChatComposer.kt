...
import ai.openaeon.android.ui.mobileSurface
import ai.openaeon.android.ui.mobileText
import ai.openaeon.android.ui.mobileTextSecondary
import ai.openaeon.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.openaeon.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.openaeon.android.ui.mobileFontFamily,
