...
import ai.openaeon.android.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("OpenAEON is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
