...
Nostr DM channel plugin for OpenAEON using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to OpenAEON. It enables your bot to:
...
# Configure openaeon to use local relay
