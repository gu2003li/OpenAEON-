...
export function listBlueBubblesAccountIds(cfg: OpenAEONConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: OpenAEONConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: OpenAEONConfig): ResolvedBlueBubblesAccount[] {
