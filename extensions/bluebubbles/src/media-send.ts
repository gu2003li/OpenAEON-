...
import { resolveChannelMediaMaxBytes, type OpenAEONConfig } from "openaeon/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: OpenAEONConfig; accountId?: string }): string[] {
