...
This directory contains the **BlueBubbles external channel plugin** for OpenAEON.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `openaeon/plugin-sdk` helpers.
