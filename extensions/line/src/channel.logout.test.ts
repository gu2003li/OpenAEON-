import type { OpenAEONConfig, PluginRuntime, ResolvedLineAccount } from "openaeon/plugin-sdk";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: OpenAEONConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: OpenAEONConfig; accountId: string }): Promise<{
