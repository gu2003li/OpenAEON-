...
export function listMattermostAccountIds(cfg: OpenAEONConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OpenAEONConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OpenAEONConfig): ResolvedMattermostAccount[] {
