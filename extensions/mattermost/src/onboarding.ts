import type { ChannelOnboardingAdapter, OpenAEONConfig, WizardPrompter } from "openaeon/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.openaeon.ai/channels/mattermost",
    ].join("\n"),
