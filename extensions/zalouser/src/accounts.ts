...
export function listZalouserAccountIds(cfg: OpenAEONConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OpenAEONConfig): string {
...
function mergeZalouserAccountConfig(cfg: OpenAEONConfig, accountId: string): ZalouserAccountConfig {
