...
Official Voice Call plugin for **OpenAEON**.
...
Docs: `https://docs.openaeon.ai/plugins/voice-call`
Plugin system: `https://docs.openaeon.ai/plugin`

## Install (local dev)

### Option A: install via OpenAEON (recommended)
...
```bash
mkdir -p ~/.openaeon/extensions
cp -R extensions/voice-call ~/.openaeon/extensions/voice-call
cd ~/.openaeon/extensions/voice-call && pnpm install
```
...
```bash
openaeon voicecall call --to "+15555550123" --message "Hello from OpenAEON"
openaeon voicecall continue --call-id <id> --message "Any questions?"
openaeon voicecall speak --call-id <id> --message "One moment"
openaeon voicecall end --call-id <id>
openaeon voicecall status --call-id <id>
openaeon voicecall tail
