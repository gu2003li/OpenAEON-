...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "openaeon/plugin-sdk";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: OpenAEONPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: OpenAEONPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
