...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "openaeon/plugin-sdk";
...
import { resolvePreferredOpenAEONTmpDir } from "../../../src/infra/tmp-openaeon-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredOpenAEONTmpDir(), "msteams-mention-"));
