...
export function listGoogleChatAccountIds(cfg: OpenAEONConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OpenAEONConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: OpenAEONConfig): ResolvedGoogleChatAccount[] {
