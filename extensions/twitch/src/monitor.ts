...
import type { ReplyPayload, OpenAEONConfig } from "openaeon/plugin-sdk";
import { createReplyPrefixOptions } from "openaeon/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as OpenAEONConfig;
