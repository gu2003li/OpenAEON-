...
Read-only diff viewer plugin for **OpenAEON** agents.
...
Set plugin-wide defaults in `~/.openaeon/openaeon.json`:
...
Before:
OpenAEON supports plugins.

After:
OpenAEON supports plugins and hosted diff views.
```
