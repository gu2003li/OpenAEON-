...
type SecretDefaults = NonNullable<OPENAEONConfig["secrets"]>["defaults"];
...
function collectCandidateAgentDirs(config: OPENAEONConfig): string[] {
  const dirs = new Set<string>();
  dirs.add(resolveUserPath(resolveOPENAEONAgentDir()));
