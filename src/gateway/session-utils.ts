...
function listConfiguredAgentIds(cfg: OPENAEONConfig): string[] {
...
export function listAgentsForGateway(cfg: OPENAEONConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OPENAEONConfig): string {
...
function resolveSessionStoreAgentId(cfg: OPENAEONConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: OPENAEONConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: OPENAEONConfig): GatewaySessionsDefaults {
