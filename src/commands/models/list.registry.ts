...
import { ensureOPENAEONModelsJson } from "../../agents/models-config.js";
...
export async function loadModelRegistry(cfg: OPENAEONConfig) {
  await ensureOPENAEONModelsJson(cfg);
  const agentDir = resolveOPENAEONAgentDir();
