...
export function applyOpenrouterProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: OPENAEONConfig): OPENAEONConfig {
...
export function applyMoonshotConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: OPENAEONConfig): OPENAEONConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: OPENAEONConfig): OPENAEONConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OPENAEONConfig): OPENAEONConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: OPENAEONConfig): OPENAEONConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: OPENAEONConfig): OPENAEONConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: OPENAEONConfig): OPENAEONConfig {
...
export function applyQianfanProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const next = applyQianfanProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, QIANFAN_DEFAULT_MODEL_REF);
}

export function applySiliconFlowGlobalProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySiliconFlowCnProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySiliconFlowGlobalConfig(cfg: OPENAEONConfig): OPENAEONConfig {
...
export function applySiliconFlowCnConfig(cfg: OPENAEONConfig): OPENAEONConfig {
...
export async function applyDeepseekWebProviderConfig(cfg: OPENAEONConfig): Promise<OPENAEONConfig> {
  const models = { ...cfg.agents?.defaults?.models };
...
export async function applyDeepseekWebConfig(cfg: OPENAEONConfig): Promise<OPENAEONConfig> {
...
export async function applyQwenWebProviderConfig(cfg: OPENAEONConfig): Promise<OPENAEONConfig> {
  const models = { ...cfg.agents?.defaults?.models };
...
export async function applyQwenWebConfig(cfg: OPENAEONConfig): Promise<OPENAEONConfig> {
