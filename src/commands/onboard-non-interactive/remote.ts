...
export async function runNonInteractiveOnboardingRemote(params: {
  ...
  if (opts.json) {
    ...
    runtime.log(
      `Tip: run \`${formatCliCommand("openaeon configure --section web")}\` to store your Brave API key for web_search. Docs: https://docs.openaeon.ai/tools/web`,
    );
  }
}
