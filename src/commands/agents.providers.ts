...
function resolveDefaultAccountId(cfg: OPENAEONConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OPENAEONConfig): boolean {
...
export function summarizeBindings(cfg: OPENAEONConfig, bindings: AgentBinding[]): string[] {
