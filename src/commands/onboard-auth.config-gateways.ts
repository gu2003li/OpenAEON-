...
export function applyVercelAiGatewayProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
...
export function applyVercelAiGatewayConfig(cfg: OPENAEONConfig): OPENAEONConfig {
