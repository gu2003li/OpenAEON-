...
export function applyOpencodeZenProviderConfig(cfg: OPENAEONConfig): OPENAEONConfig {
...
export function applyOpencodeZenConfig(cfg: OPENAEONConfig): OPENAEONConfig {
