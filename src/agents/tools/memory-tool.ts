...
function resolveMemoryToolContext(options: { config?: OPENAEONConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: OPENAEONConfig): MemoryCitationsMode {
