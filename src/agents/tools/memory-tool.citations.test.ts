...
function asOPENAEONConfig(config: Partial<OPENAEONConfig>): OPENAEONConfig {
  return config as OPENAEONConfig;
}

function createToolConfig() {
  return asOPENAEONConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: OPENAEONConfig = createToolConfig()) {
