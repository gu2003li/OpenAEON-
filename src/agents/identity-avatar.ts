...
function resolveAvatarSource(cfg: OPENAEONConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OPENAEONConfig, agentId: string): AgentAvatarResolution {
