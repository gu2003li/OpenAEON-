...
async function resolveContext(config: OPENAEONConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): OPENAEONConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
