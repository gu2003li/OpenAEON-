...
export { findNormalizedProviderKey, findNormalizedProviderValue, normalizeProviderId };

export function isCliProvider(provider: string, cfg?: OPENAEONConfig): boolean {
...
export function resolveModelRefFromString(params: {
  ...
  if (!model.includes("/")) {
    ...
    if (aliasKey === "deepseek-web") {
      return { ref: { provider: "deepseek-web", model: "deepseek-chat" }, alias: "deepseek-web" };
    }
    if (aliasKey === "qwen-web") {
      return { ref: { provider: "qwen-web", model: "Qwen3-Max" }, alias: "qwen-web" };
    }
