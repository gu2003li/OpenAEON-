...
function resolveWatchPaths(workspaceDir: string, config?: OPENAEONConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OPENAEONConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OPENAEONConfig }) {
