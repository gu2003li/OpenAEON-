...
*** End Patch`;
  ...
  function createMainSessionTools(cfg: OPENAEONConfig) {
  ...
  function createMainAgentConfig(params: {
    tools: NonNullable<OPENAEONConfig["tools"]>;
    agentTools?: NonNullable<NonNullable<OPENAEONConfig["agents"]>["list"]>[number]["tools"];
  }): OPENAEONConfig {
    return {
      tools: params.tools,
      agents: {
