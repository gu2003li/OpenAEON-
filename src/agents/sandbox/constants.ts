...
export const DEFAULT_SANDBOX_IMAGE = "openaeon-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "openaeon-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "openaeon-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "openaeon-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "openaeon-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "openaeon-sandbox-browser";
