...
// Prefix for OPENAEON-generated action IDs to scope our handler
const OPENAEON_ACTION_PREFIX = "openaeon:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${OPENAEON_ACTION_PREFIX}`);

  // Handle OPENAEON modal submissions with callback_ids scoped by our prefix.
