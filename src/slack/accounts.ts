...
function mergeSlackAccountConfig(cfg: OPENAEONConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OPENAEONConfig): ResolvedSlackAccount[] {
