...
export type ChannelAgentToolFactory = (params: { cfg?: OPENAEONConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OPENAEONConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OPENAEONConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OPENAEONConfig }) => boolean;
  supportsCards?: (params: { cfg: OPENAEONConfig }) => boolean;
