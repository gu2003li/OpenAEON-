...
import { discoverOPENAEONPlugins } from "../../plugins/discovery.js";
import type { OPENAEONPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, OPENAEONPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["OPENAEON_PLUGIN_CATALOG_PATHS", "OPENAEON_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<OPENAEONPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: OPENAEONPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverOPENAEONPlugins({ workspaceDir: options.workspaceDir });
