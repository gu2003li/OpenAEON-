...
export function listChannelMessageActions(cfg: OPENAEONConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: OPENAEONConfig): boolean {
...
export function supportsChannelMessageCards(cfg: OPENAEONConfig): boolean {
