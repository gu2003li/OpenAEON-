...
function mergeIMessageAccountConfig(cfg: OPENAEONConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OPENAEONConfig): ResolvedIMessageAccount[] {
