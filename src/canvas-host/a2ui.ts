...
export const A2UI_PATH = "/__openaeon__/a2ui";

export const CANVAS_HOST_PATH = "/__openaeon__/canvas";

export const CANVAS_WS_PATH = "/__openaeon__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.openaeonCanvasA2UIAction.postMessage(...)
  // - Android: window.openaeonCanvasA2UIAction.postMessage(...)
  const handlerNames = ["openaeonCanvasA2UIAction"];
  ...
  globalThis.OPENAEON = globalThis.OPENAEON ?? {};
  globalThis.OPENAEON.postMessage = postToNode;
  globalThis.OPENAEON.sendUserAction = sendUserAction;
  globalThis.openaeonPostMessage = postToNode;
  globalThis.openaeonSendUserAction = sendUserAction;
