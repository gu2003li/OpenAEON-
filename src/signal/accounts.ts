...
function mergeSignalAccountConfig(cfg: OPENAEONConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OPENAEONConfig): ResolvedSignalAccount[] {
