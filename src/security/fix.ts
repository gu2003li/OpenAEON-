...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OPENAEONConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OPENAEONConfig; env: NodeJS.ProcessEnv }): {
  cfg: OPENAEONConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
