...
import { loadOPENAEONPlugins } from "./loader.js";
import { createPluginLoaderLogger } from "./logger.js";
import type { OPENAEONPluginToolContext } from "./types.js";
...
export function resolvePluginTools(params: {
  context: OPENAEONPluginToolContext;
  ...
  const registry = loadOPENAEONPlugins({
