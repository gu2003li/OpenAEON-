...
export const PLUGIN_MANIFEST_FILENAME = "openaeon.plugin.json";
...
// package.json "openaeon" metadata (used for onboarding/catalog)
...
export type OPENAEONPackageManifest = {
  extensions?: string[];
...
): OPENAEONPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
