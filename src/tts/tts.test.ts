...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.OPENAEON_TTS_PREFS;
      process.env.OPENAEON_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.OPENAEON_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: OPENAEONConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
