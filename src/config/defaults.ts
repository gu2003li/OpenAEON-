...
import { normalizeProviderId } from "../agents/normalize-provider-id.js";
...
function resolveAnthropicDefaultAuthMode(cfg: OPENAEONConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OPENAEONConfig): OPENAEONConfig {
...
export function applyTalkApiKey(config: OPENAEONConfig): OPENAEONConfig {
...
export function applyTalkConfigNormalization(config: OPENAEONConfig): OPENAEONConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: OPENAEONConfig): OPENAEONConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OPENAEONConfig): OPENAEONConfig {
...
export function applyLoggingDefaults(cfg: OPENAEONConfig): OPENAEONConfig {
...
export function applyContextPruningDefaults(cfg: OPENAEONConfig): OPENAEONConfig {
...
export function applyCompactionDefaults(cfg: OPENAEONConfig): OPENAEONConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
...
export function applyToolsDefaults(cfg: OPENAEONConfig): OPENAEONConfig {
