...
import { getAeonParameters } from "../../gateway/aeon-state.js";
...
type AgentDefaults = NonNullable<OPENAEONConfig["agents"]>["defaults"];
...
type RunPreparedReplyParams = {
  ...
  sessionCfg: OPENAEONConfig["session"];
...
export async function runPreparedReply(
  ...
  const followupRun = {
    ...
    run: {
      ...
      streamParams: buildStreamParams({
        modelOptions: {
          ...getAeonParameters(),
          ...opts?.modelOptions,
        },
