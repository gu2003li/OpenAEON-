...
function resolveAcpStreamCoalesceIdleMs(cfg: OPENAEONConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: OPENAEONConfig): number {
...
export function resolveAcpProjectionSettings(cfg: OPENAEONConfig): AcpProjectionSettings {
