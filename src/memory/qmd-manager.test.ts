...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: OPENAEONConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: OPENAEONConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__openaeonMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__openaeonMcporterColdStartWarned;
  });
