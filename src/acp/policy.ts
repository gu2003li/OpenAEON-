...
export function isAcpEnabledByPolicy(cfg: OPENAEONConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: OPENAEONConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: OPENAEONConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: OPENAEONConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: OPENAEONConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: OPENAEONConfig, agentId: string): boolean {
