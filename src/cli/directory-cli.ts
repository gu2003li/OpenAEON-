    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["openaeon directory self --channel slack", "Show the connected account identity."],
          [
            'openaeon directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["openaeon directory groups list --channel discord", "List available groups/channels."],
          [
            "openaeon directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.openaeon.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
