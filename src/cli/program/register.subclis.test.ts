...
describe("registerSubCliCommands", () => {
  ...
  const originalDisableLazySubcommands = process.env.OPENAEON_DISABLE_LAZY_SUBCOMMANDS;
  ...
  beforeEach(() => {
    if (originalDisableLazySubcommands === undefined) {
      delete process.env.OPENAEON_DISABLE_LAZY_SUBCOMMANDS;
    } else {
      process.env.OPENAEON_DISABLE_LAZY_SUBCOMMANDS = originalDisableLazySubcommands;
    }
