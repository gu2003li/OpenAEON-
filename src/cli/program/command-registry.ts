...
const coreEntries: CoreCliEntry[] = [
  ...
  },
  {
    commands: [
      {
        name: "start",
        description: "Start the OPENAEON Gateway service",
        hasSubcommands: false,
      },
    ],
    register: async ({ program }) => {
  ...
  },
  {
    commands: [
      {
        name: "run",
        description: "Run the OPENAEON Gateway in the foreground",
        hasSubcommands: false,
      },
    ],
    register: async ({ program }) => {
      ...
      addGatewayRunCommand(
        program.command("run").description("Run the OPENAEON Gateway in the foreground"),
      );
    },
  },
  {
  ...
  },
  {
    commands: [
      {
        name: "browser",
        description: "Manage OPENAEON's dedicated browser (Chrome/Chromium)",
        hasSubcommands: true,
      },
    ],
    register: async ({ program }) => {
