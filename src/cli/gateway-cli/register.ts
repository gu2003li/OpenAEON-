      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["openaeon gateway run", "Run the gateway in the foreground."],
            ["openaeon gateway status", "Show service status and probe reachability."],
            ["openaeon gateway discover", "Find local and wide-area gateway beacons."],
            ["openaeon gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.openaeon.ai/cli/gateway")}\n`,
      ),
  );
