    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["openaeon channels list", "List configured channels and auth profiles."],
          ["openaeon channels status --probe", "Run channel status checks and probes."],
          [
            "openaeon channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["openaeon channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.openaeon.ai/cli/channels",
        )}\n`,
    );
