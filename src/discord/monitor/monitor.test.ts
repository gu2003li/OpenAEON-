...
describe("agent components", () => {
  const createCfg = (): OPENAEONConfig => ({}) as OPENAEONConfig;
...
describe("discord component interactions", () => {
  const createCfg = (): OPENAEONConfig =>
    ({
      channels: {
        discord: {
          replyToMode: "first",
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/openaeon-sessions-test.json");
  });
