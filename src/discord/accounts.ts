...
function mergeDiscordAccountConfig(cfg: OPENAEONConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: OPENAEONConfig): ResolvedDiscordAccount[] {
