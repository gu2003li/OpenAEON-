...
describe("resolveTaskScriptPath", () => {
  it.each([
    {
      name: "uses default path when OPENAEON_PROFILE is unset",
      env: { USERPROFILE: "C:\\Users\\test" },
      expected: path.join("C:\\Users\\test", ".openclaw", "gateway.cmd"),
    },
    {
      name: "uses profile-specific path when OPENAEON_PROFILE is set to a custom value",
      env: { USERPROFILE: "C:\\Users\\test", OPENAEON_PROFILE: "jbphoenix" },
      expected: path.join("C:\\Users\\test", ".openclaw-jbphoenix", "gateway.cmd"),
    },
    {
      name: "prefers OPENAEON_STATE_DIR over profile-derived defaults",
      env: {
        USERPROFILE: "C:\\Users\\test",
        OPENAEON_PROFILE: "rescue",
        OPENAEON_STATE_DIR: "C:\\State\\openclaw",
      },
      expected: path.join("C:\\State\\openclaw", "gateway.cmd"),
    },
    {
      name: "falls back to HOME when USERPROFILE is not set",
      env: { HOME: "/home/test", OPENAEON_PROFILE: "default" },
...
describe("readScheduledTaskCommand", () => {
  ...
  it("reads script from OPENAEON_STATE_DIR override", async () => {
    await withScheduledTaskScript(
      {
        env: (tmpDir) => ({ OPENAEON_STATE_DIR: path.join(tmpDir, "custom-state") }),
