...
describe("resolveSystemdUserUnitPath", () => {
  it.each([
    {
      name: "uses default service name when OPENAEON_PROFILE is unset",
      env: { HOME: "/home/test" },
      expected: "/home/test/.config/systemd/user/openclaw-gateway.service",
    },
    {
      name: "uses profile-specific service name when OPENAEON_PROFILE is set to a custom value",
      env: { HOME: "/home/test", OPENAEON_PROFILE: "jbphoenix" },
      expected: "/home/test/.config/systemd/user/openclaw-gateway-jbphoenix.service",
    },
    {
      name: "prefers OPENAEON_SYSTEMD_UNIT over OPENAEON_PROFILE",
      env: {
        HOME: "/home/test",
        OPENAEON_PROFILE: "jbphoenix",
        OPENAEON_SYSTEMD_UNIT: "custom-unit",
      },
      expected: "/home/test/.config/systemd/user/custom-unit.service",
    },
    {
      name: "handles OPENAEON_SYSTEMD_UNIT with .service suffix",
      env: {
        HOME: "/home/test",
        OPENAEON_SYSTEMD_UNIT: "custom-unit.service",
      },
      expected: "/home/test/.config/systemd/user/custom-unit.service",
    },
    {
      name: "trims whitespace from OPENAEON_SYSTEMD_UNIT",
      env: {
        HOME: "/home/test",
        OPENAEON_SYSTEMD_UNIT: "  custom-unit  ",
      },
...
describe("systemd service control", () => {
  ...
  it("restarts a profile-specific user unit", async () => {
    ...
    await restartSystemdService({ stdout, env: { OPENAEON_PROFILE: "work" } });
