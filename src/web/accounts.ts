...
export function listWhatsAppAuthDirs(cfg: OPENAEONConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OPENAEONConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: OPENAEONConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OPENAEONConfig): ResolvedWhatsAppAccount[] {
