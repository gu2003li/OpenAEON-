...
describe("browser control evaluate gating", () => {
  beforeEach(async () => {
    ...
    prevGatewayPort = process.env.OPENAEON_GATEWAY_PORT;
    process.env.OPENAEON_GATEWAY_PORT = String(testPort - 2);
    prevGatewayToken = process.env.OPENAEON_GATEWAY_TOKEN;
    prevGatewayPassword = process.env.OPENAEON_GATEWAY_PASSWORD;
